...
On/Off button 1 enabled: <input type="checkbox" name="BT1"><br>
On/Off button 2 enabled: <input type="checkbox" name="BT2"><br>
On/Off button 3 enabled: <input type="checkbox" name="BT3"><br>Infrared remote: 
...
type="number" min="0" max="250" required><br>Button 1 short press Preset: <input
 name="MP1" type="number" min="0" max="250" required><br>Long Press: <input 
name="ML1" type="number" min="0" max="250" required> Double press: <input 
name="MD1" type="number" min="0" max="250" required><br>
Button 2 short press Preset: <input name="MP2" type="number" min="0" max="250" 
required><br>Long Press: <input name="ML2" type="number" min="0" max="250" 
required> Double press: <input name="MD2" type="number" min="0" max="250" 
required><br>Button 3 short press Preset: <input name="MP3" type="number" 
min="0" max="250" required><br>Long Press: <input name="ML3" type="number" 
min="0" max="250" required> Double press: <input name="MD3" type="number" 
min="0" max="250" required><br>Countdown-Over Preset: <input name="MC" 
type="number" min="0" max="250" required><br>Timed-Light-Over Presets: <input 
name="MN" type="number" min="0" max="250" required><br><h3>
